...
public class LegacyJRPCHandshakeDecoder<T extends ProtocolInformationProvider & LogProvider> extends ByteToMessageDecoder {

    private final T provider;

    public LegacyJRPCHandshakeDecoder(final T provider) {
